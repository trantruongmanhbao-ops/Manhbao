...
if Settings.Translator == true then
    pcall(function()
        _G.Translator = HttpService:JSONDecode(game:HttpGet("https://raw.githubusercontent.com/PlockScripts/newredz/refs/heads/main/NewTranslator/NewBloxFruits/NewPortuguese.json"))
    end)
end
...
local v466 = vu32:MakeWindow({
    Title = "Manhbao hub [ NEW VERSION BY MANHBAO ] : Blox Fruits",
    SubTitle = "By manhbao",
...
v484:AddDiscordInvite({
    ...
    Logo = "rbxassetid://125181362377056",
                                    ...
                                    if not l_Character_7:FindFirstChild("Tushita") and not l_Backpack_1:FindFirstChild("Tushita") then
                                        if not v798 then
                                            game.StarterGui:SetCore("SendNotification", {
                                                ...
                                                con = "rbxassetid://125181362377056",
                                                Duration = 10
                                            })
                                            v798 = true
                                        end
