...
local v466 = vu32:MakeWindow({
    Title = "Manhbao hub [ NEW VERSION BY ZERO ] : Blox Fruits",
    SubTitle = "by manhbao",
    SaveFolder = "Redz | redz lib v5.lua"
})

v466:AddMinimizeButton({
    Button = { Image = "rbxassetid://117706072543025", BackgroundTransparency = 0 },
...
v484:AddDiscordInvite({
    ...
    Logo = "rbxassetid://https://117706072543025",
    Invite = "https://discord.com/channels/1477862148679139494/1477862149341577270"
})
